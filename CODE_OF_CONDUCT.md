...
# ai-notes Contributor Code of Conduct

## Purpose

ai-notes is a professional, open source project stewarded by Blackcat Informatics® Inc. Our goal is to build great tooling together. We expect everyone who participates to help maintain a respectful, collaborative environment focused on technical excellence.
...
The following is not acceptable in any ai-notes space (issues, pull requests, discussions, chats, events):
...
* Email **conduct@blackcat.ca** (maintained by the ai-notes core team)
...
This policy is adapted from common open source codes of conduct and tailored for the ai-notes project. Thank you for helping us keep the community professional and welcoming.
