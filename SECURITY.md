...
# ai-notes Security Policy

ai-notes is maintained by Blackcat Informatics® Inc. and we take security seriously. This policy explains how to report issues responsibly and what you can expect from us.
...
2. The ai-notes maintainers confirm and triage issues.
...
For general questions about ai-notes, please use GitHub discussions or open an issue with the "question" label.
